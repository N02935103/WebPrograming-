...
LogApp.controller('ProfileController',function($scope,LogAppHelper){
    ...
    $scope.timelinedb=[
        {type:'food',date_added:today,goal:'My Food Goals',calories:500,specified_goal:'My Food Goad all',img_url:'img/sb1.jpg' },
        {type:'exercise',date_added:today,goal:'My Exer Goals',calories:500,specified_goal:'My Exer Goad all',img_url:'img/sb1.jpg' },
        {type:'exercise',date_added:today,goal:'My Exer Goals',calories:500,specified_goal:'My Exer Goad all' ,img_url:'img/sb1.jpg'},
        {type:'food',date_added:today,goal:'My Food Goals',calories:500,specified_goal:'My Food Goad all',img_url:'img/sb1.jpg' },
        {type:'exercise',date_added:today,goal:'My Exer Goals',calories:500,specified_goal:'My Exer Goad all last',img_url:'img/sb1.jpg' }
